  ...
  function interpolate(step, data) {
    for (let i = 0; i < data.length; i++) {
      if (step === data[i].stepSize) {
        console.log("Check!");
        console.log(data[i].stepSize + "equals" + stepSize1);
        console.log(data[i].marginValue + "equals" + stepSize1);
        console.log(data[i].arrowWidth + "equals" + stepSize1);
        return {
        ...
        >
          ...
          {index === Number(start1) && click1 !== "" && click2 !== "" && (
            <div className="flex flex-col items-center justify-center ml-[3px]">
              <div
                style={{
                  marginRight: interpolatedMargin1,
                  top: 31.2,
                }}
          ...
          {index === Number(start2) && click3 !== "" && click4 !== "" && (
            <div className="flex flex-col items-center justify-center ml-[3px]">
              <div
                style={{
                  marginRight: interpolatedMargin2,
                  top: 31.2,
                }}
                className={`flex flex-col h-10 items-center absolute font-bold ${
